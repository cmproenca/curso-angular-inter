...
export class ListagemFilmesComponent implements OnInit {
  readonly semFoto = 'https://www.inovegas.com.br/site/wp-content/uploads/2017/08/sem-foto.jpg';
  ...
  ngOnInit(): void {
    ...
    this.generos = ['Ação', 'Romance', 'Aventura', 'Terror', 'Ficção Científica', 'Comédia', 'Drama', 'Suspense']; 
    this.listarFilmes();
  }
